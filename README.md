...
- [eww](#eww)
	- [eww.yuck](#ewwyuck)
	- [cheatsheet.yuck](#cheatsheetyuck)
	- [bar.yuck](#baryuck)
	- [eww.scss](#ewwscss)
...
```bash
sudo apt install -y virtualbox-guest-x11 linux-headers-$(uname-r) xorg dkms build-essential bspwm kitty feh polybar picom rofi i3lock flameshot xclip firefox-esr ntpsec-ntpdate locate unzip openvpn curl jq moreutils
sudo updatedb
```
